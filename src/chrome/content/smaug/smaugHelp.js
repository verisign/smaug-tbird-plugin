...
SmgInitCommon("smaugHelp");

function smgHelpLoad() {
  DEBUG_LOG("smaugHelp.js: smgHelpLoad\n");
  ...
  contentFrame.document.location.href="chrome://smaug/locale/help/"+helpFile+".html";
}
