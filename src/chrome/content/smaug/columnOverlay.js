...
Smaug.columnHandler = {
  ...
  getSortLongForRow:   function(hdr) {
    var statusFlags = hdr.getUint32Property("smaug");
    if ((statusFlags & this.nsIEnigmail.GOOD_SIGNATURE) &&
        (statusFlags & this.nsIEnigmail.DECRYPTION_OKAY))
      return 3;
    else if (statusFlags & this.nsIEnigmail.GOOD_SIGNATURE)
  ...
  createDbObserver: {
    ...
    {
      gDBView.addColumnHandler("smaugStatusCol", Smaug.columnHandler);
    }
  }
};
...
window.addEventListener("load",
  function () {
    ...
    ObserverService.addObserver(Smaug.columnHandler.createDbObserver, "MsgCreateDBView", false);
  },
  false
);
