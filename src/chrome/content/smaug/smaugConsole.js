...
function consoleLoad() {
  Ec.DEBUG_LOG("smaugConsole.js: consoleLoad\n");
...
function consoleUnload() {
  Ec.DEBUG_LOG("smaugConsole.js: consoleUnload\n");
...
function refreshConsole() {
  //Ec.DEBUG_LOG("smaugConsole.js: refreshConsole():\n");

  if (SmaugConsole.hasNewData()) {
    Ec.DEBUG_LOG("smaugConsole.js: refreshConsole(): hasNewData\n");
...
function updateData() {
  //Ec.DEBUG_LOG("smaugConsole.js: updateData():\n");
    ...
    consoleElement.firstChild.data = Ec.convertToUnicode(SmaugConsole.getData(), "utf-8");
...
function smaugConsoleCopy()
{
  var selText = getSelectionStr();

  Ec.DEBUG_LOG("smaugConsole.js: smaugConsoleCopy: selText='"+selText+"'\n");
...
{
  Ec.DEBUG_LOG("smaugConsole.js: isItemSelected\n");
  return getSelectionStr() != "";
}

function UpdateCopyMenu()
{
  Ec.DEBUG_LOG("smaugConsole.js: UpdateCopyMenu\n");
